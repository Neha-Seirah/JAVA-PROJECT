...
public class signup {
	...
	private final static String ADMIN_CODE = "christ123";
	...
	public void signUpView() {
        ...
        adminCodeLabel.setBounds(160, 330, 150, 30);
        frame.add(adminCodeLabel);

        JPasswordField adminCodeField = new JPasswordField();
        adminCodeField.setBounds(160, 360, 150, 30);
        frame.add(adminCodeField);
		
		JButton submit = new JButton("SUBMIT");
		submit.setBounds(185, 400, 100, 40);
		frame.add(submit);
		submit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String adminCode = new String(adminCodeField.getPassword());
				if(fname.isEmpty() || uname.isEmpty() || pass1.isEmpty()|| pass2.isEmpty() || adminCode.isEmpty()) {
					...
					if(pass1.equals(pass2)) {
                        ...
                        if (adminCode.equals(ADMIN_CODE)) {
                            ...
                            JOptionPane.showMessageDialog(frame, "Incorrect Admin Code", "Warning Message", JOptionPane.WARNING_MESSAGE);
                        }

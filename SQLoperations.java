...
public class SQLoperations {
	...
	public void addTotal(String quizcode) throws SQLException {
		String str = "UPDATE userQuestions SET total = total+1 WHERE quizcode = '"+quizcode+"'" ;
		Statement stm = con.createStatement();
		stm.executeUpdate(str);
	}
    ...
    public ResultSet getCounts(String code) {
        
        throw new UnsupportedOperationException("Unimplemented method 'getCounts'");
    }
